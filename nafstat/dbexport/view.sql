...
SELECT match_date as date, match.tournament_id, match.match_id, tournament.name as tournament_name,
    coach_home.name as home_coach, homerace.race as home_race, home.result as home_result, home.score as home_score,
...
LEFT JOIN coach coach_home ON home.coach_id=coach_home.naf_number
LEFT JOIN coach coach_away ON away.coach_id=coach_away.naf_number;
